...
Вот что я умею:
📚 Каждый день присылаю до 15 новых слов и фраз — каждое ОДНИМ сообщением: \
голосовое произношение слова с подписью прямо под ним (эмодзи-иллюстрация + перевод + пример) — тапнул и услышал
...
Погнали! Вот твоя первая подборка слов 👇 (у каждого слова — голосовое сообщение, тапни на плеер, чтобы услышать именно его)
"""
