...
аудио-файл с произношением слова и подписью прямо под ним (эмодзи-иллюстрация + перевод + пример) — тапнул и услышал
...
Погнали! Вот твоя первая подборка слов 👇 (у каждого слова — свой аудио-файл, тапни на плеер, чтобы услышать именно его)
"""
