...
эмодзи-иллюстрация + перевод, а произношение — по нажатию на кнопку ▶️ под каждым словом \
(специально по кнопке, а не всё сразу — иначе Telegram сцепляет автовоспроизведение всех слов подряд)
...
Погнали! Вот твоя первая подборка слов 👇 (у каждого слова своя кнопка ▶️ — нажми, чтобы услышать именно его)
"""
